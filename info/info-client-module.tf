...
info_server_ipaddress=${aws_instance.info_server.public_dns} \
...
EOF
  ...
  depends_on = [aws_db_instance.infodb , aws_instance.info_server, null_resource.create_client_package]
} 
